      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-blue-100 text-lg leading-relaxed">
            Automate course outcomes and program outcomes tracking with
            intelligent analysis and comprehensive reporting for accreditation
            excellence.
          </p>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <div className="text-center">
              <a
                href="#support"
                className="text-sm text-gray-600 hover:text-gray-900 inline-flex items-center gap-1.5 group"
              >
                <svg
